...
stats_to_display = df.describe().drop(['count', '25%', '50%', '75%'], axis=0) 
...
st.write("This table displays the predicted prices for the next 7 days based on the LSTM model, scaled down to their original values.")
